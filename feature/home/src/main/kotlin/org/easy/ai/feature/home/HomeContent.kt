...
import org.easy.ai.feature.home.components.HomeScreenDrawer
import org.easy.ai.feature.home.components.ChatMessageItemView
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        items(homeUiState.history) { message ->
                            ChatMessageItemView(modifier = Modifier.fillMaxWidth(), message = message)
                        }
                    }
                    Row(
                        ...
                        IconButton(
                            ...
                            enabled = homeUiState.userMessage.isNotBlank()
                        ) {
                            Icon(
